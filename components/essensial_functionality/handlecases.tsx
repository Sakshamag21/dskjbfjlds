...
export const handleEdit = (key: number, sem:DataType[], setSem:any, sem_num:number, setSemData:any, semData:DataType[][], 
...
export const handleDelete = (key:number, sem:DataType[], setSem:any, sem_num:number, count:number, setCount:any,
