...
export const addAllData = (setSemData:any, semData:DataType[][], sem1:DataType[], sem2:DataType[], sem3:DataType[], 
...
export const defaultColumns = (sem:DataType[], setSem:any, sem_num:number, count:number, setCount:any,
    setSemData:any, semData:DataType[][], sem1:DataType[], sem2:DataType[], sem3:DataType[], 
    sem4:DataType[], sem5:DataType[], sem6:DataType[], sem7:DataType[], sem8:DataType[], sem9:DataType[], 
    sem10:DataType[], sem11:DataType[], sem12:DataType[], sem13:DataType[], sem14:DataType[], sem15:DataType[], 
    sem16:DataType[]) => [
    {
    ...
    },
    {
      ...
      render: (_:any, record: { key: number, is_repeated:boolean }) =>
        sem.length >= 1 ? (
          <div>
          <Popconfirm title="Sure to delete?" onConfirm={() => handleDelete(record.key, sem, setSem, sem_num, count, setCount,
